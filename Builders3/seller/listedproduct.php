...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_product'])) {
    ...
    $quantity = $_POST['quantity']; // Capture the quantity
    ...
    if (isset($_FILES['product_image']) && $_FILES['product_image']['error'] == 0) {
        ...
        if (move_uploaded_file($_FILES['product_image']['tmp_name'], $uploadPath)) {
            // Call editProduct with the image name and quantity
            $sellerDashboard->editProduct($productId, $productName, $productDescription, $productPrice, $categoryId, $quantity, $imageName);
        } else {
            echo "Image upload failed.";
        }
    } else {
        // Call editProduct without the image
        $sellerDashboard->editProduct($productId, $productName, $productDescription, $productPrice, $categoryId, $quantity);
    }
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <td>Description</td>
                    <td>Category</td>
                    <td>Quantity</td> <!-- Added Quantity Column -->
                    <td>Image</td>
                    <td>Price</td>
                    <td>Actions</td>
                </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal" 
                                    ...
                                    data-image="product_images2/<?php echo $product['product_image1']; ?>"
                                    data-quantity="<?php echo $product['quantity']; ?>"> <!-- Add data-quantity attribute -->
                                    Edit
                                </button>
        ...
        <div class="modal-body">
            <div class="card" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Quantity: <span id="view-product-quantity"></span></li> <!-- Added Quantity -->
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <img src="" id="edit-product-image" alt="Current Product Image" class="mt-2" width="100">
                </div>
            </div>
...
<script>
    ...
    viewModal.addEventListener('show.bs.modal', function (event) {
        ...
        document.getElementById('view-product-quantity').innerText = button.getAttribute('data-quantity');
    });
